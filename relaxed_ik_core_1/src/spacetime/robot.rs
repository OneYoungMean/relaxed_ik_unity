...
#[derive(Clone, Debug)]
pub struct Robot {
    pub arms: Vec<arm::Arm>,//OYM:机械臂信息
    pub joint_names: Vec<Vec<String>>,//OYM:节点名称
    pub joint_ordering: Vec<String>,//OYM:节点顺序
    pub num_chains: usize,//OYM:链条数量 equal to arm.size
    pub num_dof: usize,//自由度数量,
    pub subchain_indices: Vec<Vec<usize>>,//子链数量?
    pub bounds: Vec< [f64; 2] >,//自由度的活动范围
    pub lower_bounds: Vec<f64>,//自由度的活动范围下
    pub upper_bounds: Vec<f64>,//OYM:自由度的活动范围上
    pub velocity_limits: Vec<f64>,  //OYM:速度限制
